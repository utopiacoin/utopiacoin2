...
#ifndef NEWCOIN_RPCPROTOCOL_H
#define NEWCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Newcoin is not connected
