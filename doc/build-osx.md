...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build newcoin, but if you want to, here's how:
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/newcoin/newcoin.git
        cd newcoin
...
If you are building `newcoind` or `Newcoin-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the Newcoin-Qt.app
...
you can monitor its process by looking at the debug.log file, like this:
    ...
    tail -f $HOME/Library/Application\ Support/Newcoin/debug.log
