...
unlocked to sign the Newcoin-Qt.app bundle.
...
allowing somebody to distribute a Newcoin-Qt.app or newcoin-qt-setup.exe with a valid
...
that the newcoin-qt.exe file inside the installer had not been tampered with.
