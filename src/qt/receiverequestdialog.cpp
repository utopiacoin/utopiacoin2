...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNewcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NewcoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNewcoinURI(info));
}
