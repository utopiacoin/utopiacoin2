...
#ifndef NEWCOIN_QT_NEWCOINUNITS_H
#define NEWCOIN_QT_NEWCOINUNITS_H
...
*/
class NewcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NewcoinUnits(QObject *parent);

    /** Newcoin units.
      @note Source: https://en.newcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NCN,
...
typedef NewcoinUnits::Unit NewcoinUnit;

#endif // NEWCOIN_QT_NEWCOINUNITS_H
