...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CNewcoinAddress demoAddress = CNewcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CNewcoinAddress setaccountDemoAddress = CNewcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CNewcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CNewcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
