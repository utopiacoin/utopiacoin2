...
###   This script attempts to download the signature file SHA256SUMS.asc from newcoin.org
...
WORKINGDIR="/tmp/newcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://newcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://newcoin.org/bin/"
VERSIONPREFIX="newcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'newcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[newcoin-]<version>-[rc[0-9]] (example: newcoin-0.9.2-rc1)"
   echo "wget output:"
